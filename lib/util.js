...
exports.toVarint = function( i ) {
    ...
    if( i < 0 ) {
        i = ~i;
        if( i <= 0x3 ) { return Buffer.allocUnsafe( [ 0xFC | i ] ); }
...
exports.downmixChannels = function( frame, channels ) {
    var monoFrame = Buffer.allocUnsafe( frame.length / 2 );
    var writeOffset = 0;
...
exports.resample = function( frame, sourceRate, targetRate ) {
    ...
    var targetFrame = Buffer.allocUnsafe( frame.length * targetRate / sourceRate );
...
exports.rescaleToUInt16LE = function( frame, sourceDepth, sourceUnsigned, sourceBE ) {
    ...
    var targetFrame = Buffer.allocUnsafe( frame.length * 16 / sourceDepth );
