...
/**
 * @summary Change a user's deafened state.
 *
 * @param {Boolean} isDeaf - The new deafened state
 */
User.prototype.setDeaf = function( isDeaf ) {
    this.client.connection.sendMessage( 'UserState', {
        session: this.session, actor: this.client.user.session, deaf: isDeaf } );
};

/**
 * @summary Change a user's muted state.
 *
 * @param {Boolean} isMute - The new muted state
 */
User.prototype.setMute = function( isMute ) {
    this.client.connection.sendMessage( 'UserState', {
        session: this.session, actor: this.client.user.session, mute: isMute } );
};
